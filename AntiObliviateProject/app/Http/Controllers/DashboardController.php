...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $response = Http::get("https://anime-api-dsfj.onrender.com/anime?_page={$page}&_limit={$limit}");
        $animes = json_decode($response->body());
        ...
        $animes = new LengthAwarePaginator($animes, $totalCount, $limit, $page, [
